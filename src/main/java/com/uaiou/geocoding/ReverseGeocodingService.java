 ...
 *
 * <p><strong>Nenhum método lança.</strong> Mesma regra de {@link
 * com.uaiou.routing.RoutingService}: provedor fora do ar, cota estourada, tempo limite ou recurso
 * desligado por falta de chave devolvem {@link Optional#empty()} — "não sei o endereço daqui" —,
 * nunca erro. Preencher formulário é conveniência; a coordenada marcada continua sendo o dado que
 * vale, e ela já está no cliente antes desta chamada.
 */
