...
/**
 * Sem chave configurada o recurso desliga <strong>de forma limpa</strong> — mesma escolha de
 * {@link com.uaiou.routing.service.DisabledRoutingService}: a aplicação sobe, os chamadores
 * continuam compilando, e o endereço vem ausente pelo mesmo caminho de um provedor fora do ar.
 *
